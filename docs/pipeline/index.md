...
The core genotyping engine. Kestrel performs mapping-free, k-mer-based variant calling against the MUC1 VNTR reference. The postprocessing pipeline filters, scores, and annotates variants through eight distinct steps. This is the most critical component of VNtyper.
