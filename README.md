...
```
The image file can also be [(downloaded)](https://e1.pcloud.link/publink/show?code=XZM7lmZAF70unah0p8hVA4E9krbemNgvm9k) and loaded via ``` Sudo docker load vntyper_1.0.0_docker.tar ```.
