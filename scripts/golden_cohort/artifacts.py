...
def read_pipeline_case(output_dir: Path, log_dir: Path, rules: list[Rule]) -> dict[str, Any]:
    ...
    return {
        ...
        "placed_unmapped_guard_count": result.get("placed_unmapped_guard_count"),
...
def read_cohort_case(output_dir: Path, log_dir: Path, rules: list[Rule]) -> dict[str, Any]:
    ...
    return {
        ...
        "cohort_call_frequency_csv": read_delimited(output_dir / "cohort_call_frequency.csv", ",", rules, "Grouping_Key"),
        "cohort_call_frequency_tsv": read_delimited(output_dir / "cohort_call_frequency.tsv", "\t", rules, "Grouping_Key"),
        "cohort_call_frequency_json": _sorted_records(read_json(output_dir / "cohort_call_frequency.json"), rules),
