...
def read_cohort_case(output_dir: Path, log_dir: Path, rules: list[Rule]) -> dict[str, Any]:
    ...
    return {
        ...
        "cohort_call_frequency_csv": read_delimited(
            output_dir / "cohort_call_frequency.csv", ",", rules, "Grouping_Key"
        ),
        "cohort_call_frequency_tsv": read_delimited(
            output_dir / "cohort_call_frequency.tsv", "\t", rules, "Grouping_Key"
        ),
