...
#
# 85 is a BRANCH-INCLUSIVE figure: `branch = true` was enabled in #196, taking the floor
...
# 85.09% and moved it to 85. See `test_branch_coverage_is_enabled` below for why the gap
# has to be guarded.
CURRENT_COVERAGE_FLOOR = 85.0
