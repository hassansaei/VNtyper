...
#
# 84 is a BRANCH-INCLUSIVE figure: `branch = true` was enabled in #196, taking the floor
...
# interchangeable. Milestone 4's focused modules and failure-path tests measured 84.68%
# and moved the integer floor to 84; see `test_branch_coverage_is_enabled` below for why
# that gap has to be guarded.
CURRENT_COVERAGE_FLOOR = 84.0
