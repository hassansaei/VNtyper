...
def test_contributor_docs_match_the_scripts_quality_scope() -> None:
    ...
    assert "7,129 of 7,660 measured units" in normalized_agents
    assert "93.07% aggregate scripts-only branch-inclusive coverage" in normalized_agents
    assert "17,189 of 19,270 measured units, or 89.20% combined branch-inclusive coverage" in normalized_agents
