...
def conditions(Kestrel_concat):
    if (Kestrel_concat['Depth_Score'] <= 0.00464) or (Kestrel_concat['Estimated_Depth_Variant_ActiveRegion'] <= 200):
        return 'Red_Zone'
    elif (Kestrel_concat['Estimated_Depth_AlternateVariant'] >= 21) and (Kestrel_concat['Depth_Score'] >= 0.00464) and (Kestrel_concat['Depth_Score'] <= 0.0051):
        return 'Low_Precision'
    elif (Kestrel_concat['Estimated_Depth_AlternateVariant'] > 100):
        return 'High_Precision'
    elif (Kestrel_concat['Estimated_Depth_AlternateVariant'] <= 20):
        return 'Low_Precision'
    elif (Kestrel_concat['Estimated_Depth_AlternateVariant'] >= 21) and (Kestrel_concat['Estimated_Depth_AlternateVariant'] < 100) and (Kestrel_concat['Depth_Score'] >= 0.0051):
        return 'High_Precision'
    elif (Kestrel_concat['Estimated_Depth_AlternateVariant'] >= 100) and (Kestrel_concat['Depth_Score'] >= 0.0051):
        return 'High_Precision*'
