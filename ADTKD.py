...
parser.add_argument('-k', '--K-mer', type=str, default=None, help='Kmer size', required=True)
...
if vcf_path.is_file():
    ...
    if None not in (fastq_1, fastq_2, reference_VNTR):
        kmer_command = "java -Xmx10g -jar " + tools_path + "kestrel-1.0.1 " + "./kestrel.jar " +  "-k " +  args.K-mer + " -r " + reference_VNTR  + " -o " + vcf_out + " -p " + sam_out + " --hapfmt " + "sam" + " && "  + "java -Xmx10g -jar " + tools_path + "picard.jar SortSam VALIDATION_STRINGENCY=SILENT " + "I=" + sam_out  + "O=" + output + "kmer_method/" + args.output + ".bam " + " SORT_ORDER=coordinate" + " --CREATE_INDEX"
